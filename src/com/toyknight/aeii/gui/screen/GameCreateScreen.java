...
//        this.mini_map = new MiniMap(size);
	...
	public void initComponents() {
		...
		//menu to choose map
		btn_back.setBounds(0, height-ts/2, width/4, ts/2);
		...
		this.add(btn_back);
		btn_play.setBounds(btn_back.getWidth(), height-ts/2, width/4, ts/2);
		...
		this.add(btn_play);
		btn_refresh.setBounds(btn_back.getWidth()+btn_play.getWidth(), height-ts/2, width/4, ts/2);
...
//		btn_preview.setBounds(btn_back.getWidth()+btn_play.getWidth()+btn_play.getWidth(), height - ts/2, width/4, ts/2);
